...
instruction_text = [
  ...
  {"command": "LLM-TRIGGER", "event": "Latency", "datalimit":1, "prompt" :"Re-evaluate the latency values and write update latency part for the analysis.", "anchor": "KPI_Latency_Analysis", "scope":"KPI_Latency"},
  {"command": "LLM-TRIGGER", "event": "Packetloss", "datalimit":1, "prompt" :"Re-evaluate the packet loss values and write update to this part of the analysis.", "anchor": "KPI_Packetloss_Analysis", "scope":"KPI_Packetloss"},
  {"command": "LLM-TRIGGER", "event": "Throughput", "datalimit":1, "prompt" :"Re-evaluate the throughput values and write update to this part of the analysis.", "anchor": "KPI_Throughput_Analysis", "scope":"KPI_Throughput"},
  {"command": "LLM-CONTENT-TRIGGER", "datalimit":1, "prompt" :"Re-evaluate the overall network slice status and write detailed analysis.", "anchor": "KPI_Analysis", "scope":"KPI_Latency_Analysis KPI_Throughput_Analysis KPI_Packetloss_Analysis"},
]
